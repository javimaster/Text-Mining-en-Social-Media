...
pathVenezuela<-"../Diccionarios/venezuela.txt"
pathColombia<-"../Diccionarios/colombia.txt"
pathArgentina<-"../Diccionarios/argentina.txt"
pathSpain<-"../Diccionarios/spain.txt"
pathChile<-"../Diccionarios/chile.txt"
pathMexico<-"../Diccionarios/mexico.txt"
pathPeru<-"../Diccionarios/peru.txt"
